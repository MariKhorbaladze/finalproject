...
document.querySelector(".list_btn_color")?.classList.remove("list_btn_color")
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    contactForm.addEventListener("submit", (e) => {
        ...
        try {
            ...
            if (name.style.border === "4px solid green" &&
                email.style.border === "4px solid green" &&
                website.style.border === "4px solid green" &&
                message.style.border === "4px solid green") {
                const data = {
                ...
                .then(data => {
                    console.log(data);
                    statusbar.textContent = "Thank you for getting in touch! We appreciate you contacting us.";
                ...
                .catch(err => {
                    console.log(err);
                    statusbar.textContent = "An error occurred while sending your message. Please try again.";
